CUDA_VISIBLE_DEVICES=0 python inference_basic.py \
 ...
 --output_dir="./checkpoints/basic_infer" \
 --validation_control_folder="./checkpoints/inference/case-1/poses" \
 --validation_image="./checkpoints/inference/case-1/reference.png" \
 --width=576 \
 --height=1024 \
 --guidance_scale=3.0 \
